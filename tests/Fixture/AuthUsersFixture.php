...
class AuthUsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'locale_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'locale_id' => ['type' => 'index', 'columns' => ['locale_id'], 'length' => []],
            'role_id' => ['type' => 'index', 'columns' => ['role_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'auth_users_ibfk_1' => ['type' => 'foreign', 'columns' => ['locale_id'], 'references' => ['auth_locales', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'auth_users_ibfk_2' => ['type' => 'foreign', 'columns' => ['role_id'], 'references' => ['auth_roles', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
